    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='board.place')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seuser.seuser')),
            ],
            options={
